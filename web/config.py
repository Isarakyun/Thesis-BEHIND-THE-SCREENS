...
class Config:
    ...
    GOOGLE_OAUTH_CLIENT_ID = os.getenv('143865604684-gv3f3maepclm4lm8el4jvuijesge73l6.apps.googleusercontent.com')
    GOOGLE_OAUTH_CLIENT_SECRET = os.getenv('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')
